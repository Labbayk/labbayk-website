...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this.oLanguage = {
				"sProcessing": "يتم البحث",
				"sLengthMenu": "إظهر _MENU_ نتائج",
				"sZeroRecords": "لا توجد نتائج متطابقة",
				"sEmptyTable": "لا توجد بيانات متاحة",
				"sInfo": "يظهر _START_ إلى _END_ من _TOTAL_ نتائج",
				"sInfoEmpty": "يظهر 0 إلى 0 من 0 نتائج",
				"sInfoFiltered": "(من مجمل _MAX_ نتائج)",
				"sInfoPostFix": "",
				"sSearch": "بحث:",
				"sUrl": "",
				"oPaginate": {
